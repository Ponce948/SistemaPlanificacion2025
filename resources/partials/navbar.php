...
<a href="/entidades" class="<?= requestIs('/entidades') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Entidades</a>
<a href="/objetivos" class="<?= requestIs('/objetivos') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Objetivos</a>
<a href="/proyectos" class="<?= requestIs('/proyectos') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Proyectos de inversión</a>
